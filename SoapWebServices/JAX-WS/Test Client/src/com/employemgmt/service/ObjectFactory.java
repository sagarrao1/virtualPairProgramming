 ...
 * generated in the com.employemgmt.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://service.employeMgmt.com/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://service.employeMgmt.com/", "getEmployeeByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.employemgmt.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.employeMgmt.com/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.employeMgmt.com/", name = "getEmployeeByIdResponse")
