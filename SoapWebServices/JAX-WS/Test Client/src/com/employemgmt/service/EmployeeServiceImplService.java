 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://service.employeMgmt.com/", wsdlLocation = "http://localhost:8080/any/thing/you/like/employeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://service.employeMgmt.com/", "EmployeeServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/any/thing/you/like/employeeService?wsdl");
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://service.employeMgmt.com/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class);
    }
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.employeMgmt.com/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class, features);
    }
