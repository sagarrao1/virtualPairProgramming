 ...
 * generated in the com.virtualpair.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://services.virtualpair.com/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://services.virtualpair.com/", "getEmployeeByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.virtualpair.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.virtualpair.com/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.virtualpair.com/", name = "getEmployeeByIdResponse")
