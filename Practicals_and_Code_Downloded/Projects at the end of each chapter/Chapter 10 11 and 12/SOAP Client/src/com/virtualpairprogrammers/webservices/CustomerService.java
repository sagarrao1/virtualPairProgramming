 ...
 * 
 */
@WebServiceClient(name = "customerService", targetNamespace = "http://webservices.virtualpairprogrammers.com/", wsdlLocation = "http://localhost:8080/mywebapp/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://webservices.virtualpairprogrammers.com/", "customerService");
    ...
    public CustomerEndpoint getCustomerEndpointPort() {
        return super.getPort(new QName("http://webservices.virtualpairprogrammers.com/", "CustomerEndpointPort"), CustomerEndpoint.class);
    }
    ...
    public CustomerEndpoint getCustomerEndpointPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.virtualpairprogrammers.com/", "CustomerEndpointPort"), CustomerEndpoint.class, features);
    }
